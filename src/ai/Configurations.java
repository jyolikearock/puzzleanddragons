...
public class Configurations {
    ...
    private static int timeLimitMillis = 9 * 1000;
    ...
    public static boolean isRowRequired(Color color) {
        String key = color.toString() + ROW_REQUIRED_KEY;
        return
                (teamInfo.containsKey(key) && !teamInfo.get(key).isEmpty()) ?
                Boolean.parseBoolean(teamInfo.get(key)) :
                false;
    }
